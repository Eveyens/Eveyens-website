    ...
    <div className="h-screen flex flex-col bg-gray-100">
      ...
      <div className="flex-shrink-0 bg-white shadow-sm border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-lg font-semibold text-gray-900">Discutez avec Eve et profitez de l'expérience 🔸 </h1>
            <p className="text-sm text-gray-500">Notre IA peut répondre à vos questions ou vous guider dans votre expérience utilisateur</p>
          </div>
        </div>
